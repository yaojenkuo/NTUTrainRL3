...
mpgAutomatic <- mtcars$mpg[mtcars$am==0]
boxplot(mtcars$mpg, mtcars$mpg[mtcars$am==0], ylab = "mpg", names=c("Overall","Automatic"))
abline(h=mean(mtcars$mpg),lwd=2, col="red")
abline(h=mean(mtcars$mpg[mtcars$am==0]),lwd=2, col="blue")
t.test(mpgAutomatic, mu=mpgMean)
```
...
```{r}
boxplot(mtcars$mpg~mtcars$am, xlab='am', ylab='mpg')
